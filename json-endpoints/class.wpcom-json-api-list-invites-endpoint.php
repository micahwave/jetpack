...
class WPCOM_JSON_API_List_Invites_Endpoint extends WPCOM_JSON_API_Endpoint {
	...
	function get_user( $invite ) {
		...
		/*
		 * sent_to can either be a user's login or email address. This is because get_blog_invitations()
		 * chooses to hide WP.com user's email addresses by replacing sent_to with the user's login.
		 *
		 * @hide-in-jetpack
		 */
